...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'dist',  # Vite build output (production)
            BASE_DIR / 'templates',  # Development templates
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'unique-analytics-cache',
        'OPTIONS': {
            'MAX_ENTRIES': 1000
        }
    }
...
# Additional locations for static files (Vite build output)
STATICFILES_DIRS = [
