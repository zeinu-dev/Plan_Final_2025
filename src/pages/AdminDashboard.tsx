...
import { organizations, auth, api, reports } from '../lib/api';
...
const AdminDashboard: React.FC = () => {
      ...
      try {
        ...
        if (adminOrg.type === 'MINISTER') {
          ...
          const childOrgIds = allOrgs.filter((org: any) =>
            org.id === adminOrgId ||
            org.parent === adminOrgId ||
            isDescendantOf(org, adminOrgId, allOrgs)
          ).map((org: any) => org.id);
  ...
  // Plans are already filtered by API
...
const ReportsTab: React.FC = () => {
  ...
  const { submission_stats, objective_achievements } = reportStats;
  ...
  return (
    <div className="space-y-8">
          ...
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg shadow-lg p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold">{submission_stats.total_organizations}</p>
          ...
          <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-lg shadow-lg p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold">{submission_stats.submitted}</p>
          ...
          <div className="bg-gradient-to-br from-red-500 to-red-600 rounded-lg shadow-lg p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold">{submission_stats.not_submitted}</p>
      ...
      <div>
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Strategic Objective Performance</h2>
        <div className="bg-white rounded-lg shadow overflow-hidden">
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {objective_achievements.length === 0 ? (
                  <tr>
                  ...
                  objective_achievements.map((obj: any) => (
                    <tr key={obj.id} className="hover:bg-gray-50">
                      <td className="px-6 py-4">
                        <div className="text-sm font-medium text-gray-900">{obj.title}</div>
                        {obj.title_amharic && (
                          <div className="text-sm text-gray-500">{obj.title_amharic}</div>
                        )}
                      </td>
                      <td className="px-6 py-4">
